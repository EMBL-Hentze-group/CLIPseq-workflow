...
# profiles to use in this run, as comma separated list. Run using SLURM scheduler, with conda for software management, and the eCLIP profile which includes protocol specific parameters and resource configurations and using hsa (hg38) genome assembly.
