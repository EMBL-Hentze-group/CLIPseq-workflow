...
PROFILE=slurm,apptainer,soniCLIP,hsa # profiles to use in this run, as comma separated list. Run using SLURM scheduler, with Apptainer for software management, and the soniCLIP profile which includes protocol specific parameters and resource configurations and using hsa (hg38) genome assembly.
